...
const MessagesDisplay = React.forwardRef(function MessagesDisplay({ messages }: any, ref) {
  const cRef: any = React.useRef();

  // useLayoutEffect
  // 如果要对dom进行可以看到的改变，用useLayoutEffect
...
function Chat() {
  ...
  const scrollToTop = () => mRef.current.scrollToTop();
  const scrollToBottom = () => mRef.current.scrollToBottom();
  ...
  return (
    <div className="messaging-app">
      ...
      <MessagesDisplay ref={mRef} messages={messages} />
      <div>
